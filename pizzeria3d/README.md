...
Scripts/Jeu/
  ...
  Emballage.cs  le plan de mise en boite : rangee de cartons et poste de travail
  Banque.cs     la caisse
...
Tests~/FakeUnity/            (ignore par Unity : le ~ final)
  ...
  Harness3D.cs    100 verifications qui jouent la boucle complete
```
...
La logique tourne : les 100 verifications ci-dessus s'executent hors editeur.
