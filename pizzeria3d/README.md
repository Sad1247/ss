...
Scripts/Jeu/
  ...
  TableRepas.cs une table : ses chaises, son etat (verrouillee/libre/occupee), les restes
  Salles.cs     le registre des tables : celle qu'on propose au client suivant
...
Tests~/FakeUnity/            (ignore par Unity : le ~ final)
  ...
  Harness3D.cs    512 verifications qui jouent la boucle complete
```
...
La logique tourne : les 512 verifications ci-dessus s'executent hors editeur.
