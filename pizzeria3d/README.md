...
Scripts/Jeu/
  ...
  TableRepas.cs la table de la salle : une place, prise ou libre
...
Tests~/FakeUnity/            (ignore par Unity : le ~ final)
  ...
  Harness3D.cs    200 verifications qui jouent la boucle complete
```
...
La logique tourne : les 200 verifications ci-dessus s'executent hors editeur.
